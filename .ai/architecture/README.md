...
- 说明 `AGENTS.md`、根 `README.md`、目录 README、`.ai/changes/`、`.ai/decisions/` 与本目录之间的分工。
- 沉淀 readme-first-builder skill 的长期职责和同步规则。
...
| `builder-skill.md` | readme-first-builder skill 的职责边界和同步规则 |
...
3. 如果修改会改变 README First 的推荐最小系统，同步检查 `documentation-contracts.md`、根 `README.md` 和 readme-first-builder skill。
